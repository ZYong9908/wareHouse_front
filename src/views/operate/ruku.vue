  ...
  <div style="margin: 5px">
    <el-form :inline="true" size="small">
      ...
      <el-form-item label="供应商">
        <el-select v-model="supplierSelect" placeholder="请选择" clearable>
...
<!--          <el-button v-permission="['admin']" type="primary" size="small" @click="edit(scope.row,scope.$index)" style="margin-right: 10px">编辑</el-button>-->
                    <el-button type="success" size="small" @click="openOperateDialog(scope.row,scope.$index,1)">入库</el-button>
          <!--          <el-button type="warning" size="small" @click="openOperateDialog(scope.row,scope.$index,0)" style="margin-right: 10px">出库</el-button>-->
